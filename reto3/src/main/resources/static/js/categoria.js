...
function cargarCategoria(idItem) {
    $.ajax({
        dataType: 'json',
        url: "http://http://localhost:8080//api/Category/" + idItem,
        type: 'GET',
...
function crearCategoria() {
    ...
    $.ajax({
        url: "http://http://localhost:8080//api/Category/save",
        type: "POST",
        data: dataToSend,
...
function actualizarCategoria() {
    ...
    datosEnvio = JSON.stringify(data);
    $.ajax({
        url: "http://http://localhost:8080//api/Category/update",
        type: "PUT",
        data: datosEnvio,
        contentType: "application/json",
        success: function (response) {
...
function eliminarCategoria() {
    ...
    $.ajax({
        url: "http://http://localhost:8080//api/Category/" + dato.id,
        type: "DELETE",
        data: datosEnvio,
        contentType: "application/json",
        success: function (response) {
